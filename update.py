...
update_packages=['image/black/ADB.png','image/black/android.jpg','image/black/approve_custom_load.png','image/black/arch.png','image/black/attetion.png', 'setting/window_and_objects.py', 'main.py']
